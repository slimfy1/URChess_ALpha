from PyQt5.QtWidgets import QApplication, QLabel, QCheckBox, QDialog, QComboBox, QGridLayout, QLineEdit
from PyQt5.QtGui import QPixmap
from PyQt5.Qt import QPushButton, pyqtSlot
import cv2
import initScreenRobot

import sys


class InitScreen(QDialog):
    def __init__(self, playerTocorrect, robot):
    ...
    def initUI(self):
        ...
        settingRobotButton = QPushButton('Robot Setting', self)
        ...
        settingRobotButton.clicked.connect(self.settingRobot)
        ...
        grid.addWidget(settingRobotButton, 0, 2)
    ...
    def settingRobot(self):
        dialog = initScreenRobot.InitScreenRobot(self.robot)
        dialog.exec()
...
class InittRoi(QDialog):
    ...
    def iniUi(self):
        ...
        startButton.clicked.connect(self.Roi)
        # self.setPlayersNum.activated[str].connect(self.Activation)
        cancelButton = QPushButton('Done', self)
    ...
    def Roi(self):
        ...
        if len(self.refPt) == 2:
            ...
            cv2.imwrite('images/tmpRoi.png', roi)
            self.roi.setPixmap(QPixmap("images/tmpRoi.png"))
